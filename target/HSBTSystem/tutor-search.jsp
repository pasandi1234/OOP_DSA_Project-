...
<head>
    ...
    <title>Search Tutors - Home Tutor Search and Booking System</title>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6 flex flex-col md:flex-row">
                        <div class="flex-shrink-0 flex items-center justify-center bg-blue-100 rounded-full w-24 h-24 md:mr-6 mb-4 md:mb-0 mx-auto md:mx-0">
                            <span class="text-blue-800 text-2xl font-bold">JD</span>
                        </div>
                        <div class="flex-grow">
                            <div class="flex flex-col md:flex-row md:justify-between md:items-start">
                                <div>
                                    <h3 class="text-xl font-bold">John Doe</h3>
                                    <p class="text-gray-600">Mathematics, Calculus, Algebra</p>
                                    <div class="flex items-center mt-1">
                                        <div class="text-yellow-400">★★★★☆</div>
                                        <span class="ml-1 text-gray-600">4.2/5</span>
                                    </div>
                                    <p class="text-gray-600 mt-1">5 years experience | $25/hour</p>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6 flex flex-col md:flex-row">
                        <div class="flex-shrink-0 flex items-center justify-center bg-blue-100 rounded-full w-24 h-24 md:mr-6 mb-4 md:mb-0 mx-auto md:mx-0">
                            <span class="text-blue-800 text-2xl font-bold">EJ</span>
                        </div>
                        <div class="flex-grow">
                            <div class="flex flex-col md:flex-row md:justify-between md:items-start">
                                <div>
                                    ...
                                    <p class="text-gray-600 mt-1">8 years experience | $30/hour</p>
                                    <p class="text-green-600 font-medium">Available</p>
                                    <p class="mt-2"><span class="font-medium">Type:</span> Online Tutor</p>
                                    <p><span class="font-medium">Platform:</span> Google Meet</p>
                                </div>
                                <div class="flex flex-col space-y-2 mt-4 md:mt-0">
