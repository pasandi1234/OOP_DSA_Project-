...
<head>
    ...
    <title>Update Booking - Home Tutor Search and Booking System</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
            ...
            <% } else {
                ...
                // Determine if it's an online or in-person booking
            ...
            <form action="update-booking" method="post" class="space-y-6">
                ...
                <div class="bg-yellow-50 p-4 rounded-lg">
                    ...
                    <p class="text-gray-700">Base Price: $<span id="basePrice"><%= String.format("%.2f", booking.getPrice()) %></span></p>
                    <% if (!isOnline && inPersonBooking.isTravelFeeApplied()) { %>
                    <p id="travelFeeText" class="text-gray-700">Travel Fee: $<span id="travelFeeAmount"><%= String.format("%.2f", inPersonBooking.getTravelFee()) %></span></p>
                    <p class="text-gray-700 font-bold">Total Estimated Price: $<span id="totalPrice"><%= String.format("%.2f", inPersonBooking.getTotalPrice()) %></span></p>
                    <% } else { %>
                    <p id="travelFeeText" class="text-gray-700 hidden">Travel Fee: $<span id="travelFeeAmount">0.00</span></p>
                    <p class="text-gray-700 font-bold">Total Estimated Price: $<span id="totalPrice"><%= String.format("%.2f", booking.getPrice()) %></span></p>
                    <% } %>
                </div>
    ...
    <script>
        ...
        // Update price estimate based on duration and travel fee
        function updatePriceEstimate() {
            ...
            if (startTime && endTime) {
                ...
                if (end > start) {
                    duration = (end - start) / (1000 * 60 * 60); // Convert milliseconds to hours
                }
            }
            ...
            // Check if travel fee applies (only for in-person bookings)
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Add event listener for travel fee if it exists
