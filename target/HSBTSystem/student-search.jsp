...
<head>
    ...
    <title>Search Students - Home Tutor Search and Booking System</title>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 gap-6">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6 flex flex-col md:flex-row">
                        <div class="flex-shrink-0 flex items-center justify-center bg-blue-100 rounded-full w-24 h-24 md:mr-6 mb-4 md:mb-0 mx-auto md:mx-0">
                            <span class="text-blue-800 text-2xl font-bold">AJ</span>
                        </div>
                        <div class="flex-grow">
                            <div class="flex flex-col md:flex-row md:justify-between md:items-start">
                                <div>
                                    <h3 class="text-xl font-bold">Alice Johnson</h3>
                                    <p class="text-gray-600">High School</p>
                                    <p class="text-gray-600 mt-1">Preferred Subjects: Mathematics, Calculus, Algebra</p>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="p-6 flex flex-col md:flex-row">
                        <div class="flex-shrink-0 flex items-center justify-center bg-blue-100 rounded-full w-24 h-24 md:mr-6 mb-4 md:mb-0 mx-auto md:mx-0">
                            <span class="text-blue-800 text-2xl font-bold">BS</span>
                        </div>
                        <div class="flex-grow">
                            <div class="flex flex-col md:flex-row md:justify-between md:items-start">
                                <div>
                                    ...
                                    <p class="text-gray-600 mt-1">Preferred Subjects: Physics, Chemistry, Biology</p>
