...
/**
 * Servlet to handle review deletion requests.
 */
public class ReviewDeleteServlet extends HttpServlet {
    ...
    /**
     * Handle GET requests to delete a review
     */
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        // Get the review ID and action from the request
                ...
                if (review != null) {
                    ...
                    try {
                        if ("delete".equals(action)) {
                            ...
                            if (success) {
                                // Redirect to the return URL with success message
        ...
        // If deletion failed, redirect to the return URL with error message
        if (reviewIdStr == null || reviewIdStr.isEmpty()) {
