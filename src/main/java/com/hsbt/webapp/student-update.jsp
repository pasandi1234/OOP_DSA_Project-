...
<head>
    ...
    <title>Update Student - EduBridge</title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="educationLevel" name="educationLevel" required
                            ...
                            <option value="Bio Science Stream" <%= "Bio Science Stream".equals(student.getEducationLevel()) ? "selected" : "" %>>Bio Science Stream</option>
                            <option value="Physical Science Stream" <%= "Physical Science Stream".equals(student.getEducationLevel()) ? "selected" : "" %>>Physical Science Stream</option>
                            <option value="Commerce Stream" <%= "Commerce Stream".equals(student.getEducationLevel()) ? "selected" : "" %>>Commerce Stream</option>
                            <option value="Arts Stream" <%= "Arts Stream".equals(student.getEducationLevel()) ? "selected" : "" %>>Arts Stream</option>
                            <option value="Technology Stream" <%= "Technology Stream".equals(student.getEducationLevel()) ? "selected" : "" %>>Technology Stream</option>
                        </select>
                    </div>
                    <div>
...
</html> i want to remove the educational level line and that details and give the full updated code