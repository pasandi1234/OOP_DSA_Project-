        ...
        <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
            ...
            <form action="register-student" method="post" class="space-y-6">
                ...
                <div class="bg-blue-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="Subject Stream" class="block text-gray-700 font-medium mb-2">Subject Stream</label>
                            <select id="Subject Stream" name="Subject Stream" required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option value="Bio Science Stream">Bio Science Stream</option>
