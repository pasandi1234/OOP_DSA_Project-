        ...
        if (page === 'register') {
                        ...
                        <form id="tutorForm">
                            ...
                            <div class="form-group">
                                ...
                                <select id="subject" required>
                                    ...
                                    <option value="Comines Maths">Comines Maths</option>
                                    <option value="Accounting">Accounting</option>
                                    <option value="Econ">Econ</option>
                                    <option value="ICT">ICT</option>
                                    <option value="Geography">Geography</option>
                                    <option value="History">Histrory</option>
                    ...
                    <div class="card">
                        ...
                        <div id="searchResults">
                            <div class="tutor-card">
                                <div class="tutor-avatar">MM</div>
                                <div class="tutor-info">
                                    <div class="tutor-name">Miuni Malkini/div>
                                    <div class="tutor-subject">hysics, Chemistry, Biology</div>
                            ...
                            <div class="tutor-card">
                                <div class="tutor-avatar">OW</div>
                                <div class="tutor-info">
                                    <div class="tutor-name">Okitha Weerasekara</div>
                                    <div class="tutor-subject">Chemistry</div>
                                    <div class="tutor-rating">★★★★★ (4.5)</div>
            ...
            contentDiv.innerHTML = `
                    ...
                    <div class="card">
                        ...
                        <p>Total Tutors: 24</p>
                        <p>Most Popular Subject: ICT (8 tutors)</p>
                        <p>Highest Rated Tutor: Miuni Malkini(4.0)</p>
                    </div>
                    <div class="card">
        ...
        contentDiv.innerHTML = `
                ...
                <div class="card">
                    <div style="display: flex; gap: 2rem;">
                        ...
                        <div>
                            <h2>Miuni Malkini</h2>
                            <p><strong>Email:</strong> Miuni Malkini@gmail.com</p>
                            <p><strong>Phone:</strong> 0741216911</p>
                            <p><strong>Subject:</strong> History,Geography,ICT</p>
                    ...
                    <div style="margin-top: 1.5rem;">
                        <h3>Bio</h3>
                        <p>Miuni Malkini is a passionate History,Geography,ICT tutor with 5 years of experience teaching high school and college students. He specializes in algebra, calculus, and geometry.</p>
                    </div>
                ...
                <div class="card">
                    <form id="editTutorForm">
                        <div class="form-group">
                            ...
                            <input type="text" id="editName" value="Okitha Weerasekara" required>
                        </div>
                        <div class="form-group">
                            <label for="editEmail">Email</label>
                            <input type="email" id="editEmail" value="OkithaWeerasekara@gmail.com" required>
                        </div>
                        <div class="form-group">
                            <label for="editPhone">Phone</label>
                            <input type="tel" id="editPhone" value="0768690430">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="editBio" rows="4">Miuni Malkini is a passionate History,Geography,ICT tutor with 5 years of experience teaching high school and college students. He specializes in algebra, calculus, and geometry.</textarea>
                        </div>
                        <div class="action-buttons">
