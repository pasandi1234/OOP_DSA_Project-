...
<head>
    ...
    <title>Tutor Registration - EduBridge </title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="subjects" name="subjects" multiple required
                            ...
                            <option value="Combined Maths">Combines Maths</option>
                    ...
                    <div>
                        ...
                        <div>
                            <label for="hourlyRate" class="block text-gray-700 font-medium mb-2">Hourly Rate (Rs.)</label>
